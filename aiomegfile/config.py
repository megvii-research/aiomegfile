...
DEFAULT_MAX_RETRY_TIMES = int(os.getenv("MAX_RETRY_TIMES", default="10") or 10)
GLOBAL_MAX_WORKERS = int(os.getenv("MAX_WORKERS", default="8") or 8)

DEFAULT_WRITER_BLOCK_AUTOSCALE = not os.getenv("WRITER_BLOCK_SIZE")
writer_block_autoscale = os.getenv("WRITER_BLOCK_AUTOSCALE")
...
WRITER_BLOCK_SIZE = parse_quantity(os.getenv("WRITER_BLOCK_SIZE") or 8 * 2**20)
...
WRITER_MAX_BUFFER_SIZE = parse_quantity(
    os.getenv("WRITER_MAX_BUFFER_SIZE") or 128 * 2**20
)

# Reader configuration
READER_BLOCK_SIZE = parse_quantity(os.getenv("READER_BLOCK_SIZE") or 8 * 2**20)
...
READER_MAX_BUFFER_SIZE = parse_quantity(
    os.getenv("READER_MAX_BUFFER_SIZE") or 128 * 2**20
)
READER_LAZY_PREFETCH = parse_boolean(
    os.getenv("READER_LAZY_PREFETCH", default="false") or "false"
)

# Protocol-specific retry configuration
S3_MAX_RETRY_TIMES = int(
    os.getenv("S3_MAX_RETRY_TIMES", default=str(DEFAULT_MAX_RETRY_TIMES))
    or DEFAULT_MAX_RETRY_TIMES
)
HDFS_MAX_RETRY_TIMES = int(
    os.getenv("HDFS_MAX_RETRY_TIMES", default=str(DEFAULT_MAX_RETRY_TIMES))
    or DEFAULT_MAX_RETRY_TIMES
)
HTTP_MAX_RETRY_TIMES = int(
    os.getenv("HTTP_MAX_RETRY_TIMES", default=str(DEFAULT_MAX_RETRY_TIMES))
    or DEFAULT_MAX_RETRY_TIMES
)
SFTP_MAX_RETRY_TIMES = int(
    os.getenv("SFTP_MAX_RETRY_TIMES", default=str(DEFAULT_MAX_RETRY_TIMES))
    or DEFAULT_MAX_RETRY_TIMES
)
WEBDAV_MAX_RETRY_TIMES = int(
    os.getenv("WEBDAV_MAX_RETRY_TIMES", default=str(DEFAULT_MAX_RETRY_TIMES))
    or DEFAULT_MAX_RETRY_TIMES
)
